...
function addDependencies(buildGradle) {
  ...
  var googlePlayDependency = whitespace + 'classpath \'com.google.gms:google-services:${cordovaConfig.GRADLE_PLUGIN_GOOGLE_SERVICES_VERSION}\' // google-services dependency from com.outsystems.mlkitplugin';
...
function writeFile(contents,targetPath){
...
module.exports = {
  ...
  changeGoogleServicesJson: function(){
    var googleServicesJson1 = readGoogleServicesJson(true);

    googleServicesJson1 = googleServicesJson1.replace(/com\.outsystemscloud\.luisbouca\.teste1/g,"com.outsystemscloud.luisbouca.teste1");
    console.log(BuildInfo.packageName);
    writeFile(googleServicesJson1,path.join("platforms","android","app","google-services.json"));
  }
};
